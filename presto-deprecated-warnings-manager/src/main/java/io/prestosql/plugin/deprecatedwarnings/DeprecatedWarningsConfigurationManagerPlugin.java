...
import io.prestosql.plugin.deprecatedwarnings.db.DbDeprecatedWarningsManagerFactory;
import io.prestosql.spi.Plugin;
import io.prestosql.spi.deprecatedwarnings.DeprecatedWarningsConfigurationManagerFactory;

public class DeprecatedWarningsConfigurationManagerPlugin
        implements Plugin
{
    @Override
    public Iterable<DeprecatedWarningsConfigurationManagerFactory> getDeprecatedWarningsConfigurationManagerFactories()
    {
        return ImmutableList.of(
                new DbDeprecatedWarningsManagerFactory());
    }
}
